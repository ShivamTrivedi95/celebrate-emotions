...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      //     serif: ["Yrsa", "Noto Serif Devanagari", "serif"],
      ...
      fontFamily: {
        ...
        serif: ["Yrsa", "Noto Serif Devanagari", "serif"],
        hindi: ["Noto Serif Devanagari", "serif"],
        display: ["Playwrite Norge", "Yrsa", "serif"],
      },
      ...
      colors: {
        ...
        // Indian-themed palette
        sindoor: {
          DEFAULT: "hsl(var(--sindoor))",
          deep: "hsl(var(--sindoor-deep))",
          glow: "hsl(var(--sindoor-glow))",
        },
        haldi: {
          DEFAULT: "hsl(var(--haldi))",
          light: "hsl(var(--haldi-light))",
        },
        marigold: {
